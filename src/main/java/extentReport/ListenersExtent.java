...
public class ListenersExtent implements ITestListener,IAbstractTest {
    ...
    public synchronized void onTestFailure(ITestResult result) {
		 ...
		 */
		  ...
		  result.getTestClass().getRealClass().getDeclaredField("ak").get(result.
		  getInstance()); }catch (IllegalArgumentException | IllegalAccessException | NoSuchFieldException | SecurityException e) {
		        e.printStackTrace();}
